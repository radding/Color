...
@property (weak, nonatomic)  UIImageView* imageViewRight;
@property (weak, nonatomic)  UIImageView* imageViewFullScreen;
@property (weak, nonatomic)  UIButton* color;
...
- (void)viewDidLoad {
    ...
    for(id i in self.view.subviews){
        switch (((UIView*)i).tag) {
            case 0:
                self.imageViewRight = i;
                break;
            case 1:
                self.imageView = i;
                break;
            case 2:
                self.imageViewFullScreen = i;
                break;
            case 3:
                self.color = i;
                break;
